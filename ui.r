    ...
    sidebarMenu(
      ...
      menuItem("Health Outcomes", tabName = "outcome", icon = icon("list"),
               ...
               menuItem("Antimicrobial resistance", tabName = "ar_rsp",
                        menuItem("Introduction", tabName = "ar_rsp_intro"),
               ...
               menuItem("Gastrointestinal diseases", tabName = "gi_rsp",
                        menuItem("Introduction", tabName = "gi_rsp_intro"),
               ...
               menuItem("Neurologic", tabName = "Neur_rsp",
                        menuItem("Introduction", tabName = "Neur_rsp_intro"),
      ...
      tabItem(tabName = "start",
              fluidRow(
                box(
                  ...
                  column(width = 12,h4("Our latest Systematic Review"),
...
when the level of odor annoyance was used as the measure of exposure."),
                    radioGroupButtons(
                      ...
                      choices = c(`<i class='fa fa-globe'></i> Geographical Distribution` = "sp",
                                  `<i class='fa fa-calendar-alt'></i> Timeline` = "ts",
                                  `<i class='fa fa-poll'></i> Outcomes` = "coef")
                    ),
...
effects."),
                    radioGroupButtons(
                      inputId = "up_res_btn", justified = TRUE, label = "",
                      choices = c(`<i class='fa fa-globe'></i> Geographical Distribution` = "sp",
                                  `<i class='fa fa-calendar-alt'></i> Timeline` = "ts",
                                  `<i class='fa fa-poll'></i> Outcomes` = "coef")
                    ),
